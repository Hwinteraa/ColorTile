...
$.playground().addGroup("background", {width: PLAYGROUND_WIDTH, height: PLAYGROUND_HEIGHT})
    ...
    .end()
    //내 거 표시할 레이어
    .addGroup("studentNumLayer", { width: PLAYGROUND_WIDTH, height: PLAYGROUND_HEIGHT })
    .addSprite("studentNumber", { animation: '', posx: 0, posy: 0, width: PLAYGROUND_WIDTH, height: PLAYGROUND_HEIGHT })
    .end()
...
//내 거 표시하기 위한 거...
$("#studentNumber").html("<span> 2022100290 Shooting game </span>"); 
...
$.playground().registerCallback(function (){
    ...
    //여기(키 지정)에 미사일 코드(스페이스바) 넣어도 무관함
}, REFRESH_RATE);
